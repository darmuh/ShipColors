...
namespace ShipColors.ConfigManager
{
    public static class ConfigSettings
    {
        ...
        public static void BindConfigSettings()
        {
            ...
            GenAcceptedLayers = MakeString(Plugin.instance.Config, "Setup", "GenAcceptedLayers", "0, 4, 6, 8, 9, 10, 26, 28, 29", "[Comma-separated listing] - This sets the acceptable layers to search for materials in each GameObject in the ship. If a GameObject has a layer not specified here it will be skipped.\nNumbers 0 to 31 are valid layers");
